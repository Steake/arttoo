...
| Attempt 2 rescues | 0 |
| Average runtime ms | 5.349 |
| Max runtime ms | 8.987 |
...
| --- | --- | --- | --- | --- | --- | --- |
| holdout_flip_vertical_task | blind_holdout | yes | yes | 8.987 | flip_vertical |  |
| holdout_rotate180_task | blind_holdout | yes | yes | 3.772 | rotate180 |  |
| holdout_translate_task | blind_holdout | yes | yes | 3.288 | translate_to_origin |  |