# Failure Summary: regression

| Primary Class | Count | Representatives | Tags | Suspected Root Cause |
| --- | --- | --- | --- | --- |
...
| Shape mismatch rejections (search) | 150 |
...
| Tag | Count |
| --- | --- |
| known_regression_fixture | 3 |
| object_count_mismatch | 3 |
